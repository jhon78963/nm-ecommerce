export const PDP_COPY = {
  ...
  basedOnReviews: (count: number) => `Basado en ${count} calificaciones`,
  reviewThisProduct: "Califica este producto",
  reviewThisProductHint: "Cuéntale a otros clientes lo que piensas.",
  writeReview: "Escribir reseña",
  yourReview: "Tu reseña",
  purchaseRequiredReview: "Solo los clientes que compraron este producto pueden dejar una reseña.",
  loginToReview: "Inicia sesión con la misma cuenta con la que compraste para dejar tu reseña.",
  loginToReviewButton: "Iniciar sesión",
  reviewRatingLabel: "Calificación",
  reviewRatingRequired: "Selecciona una calificación.",
  reviewContentLabel: "Comentario",
  reviewContentPlaceholder: "Escribe tu experiencia con el producto...",
  reviewDescriptionRequired: "El comentario debe tener al menos 10 caracteres.",
  reviewSubmit: "Enviar reseña",
  reviewSubmitting: "Enviando...",
  reviewCancel: "Cancelar",
  reviewSubmitError: "No se pudo enviar la reseña.",
  reviewPendingNotice: "Tu reseña quedará pendiente de aprobación antes de publicarse.",
